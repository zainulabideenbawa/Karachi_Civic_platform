        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-4">
          ...
          <div className="p-3.5 rounded-xl bg-slate-50 dark:bg-slate-800/60 border border-slate-200 dark:border-slate-700 space-y-3">
            {isConfirmationWindow ? (
              // 7-Day Confirmation Window (Section 5.3)
              <div className="space-y-2">
                ...
                <p className="text-[11px] text-slate-500">
                  Did the municipal team resolve this on ground? Your vote directly impacts the UC Chairman&apos;s score.
                </p>

                <div className="grid grid-cols-2 gap-2 pt-1">
                  <button
                    onClick={() => voteConfirmation(selectedIssue.id, "fixed")}
                  ...
                  <button
                    onClick={() => voteConfirmation(selectedIssue.id, "not_fixed", "Gutter still leaking")}
